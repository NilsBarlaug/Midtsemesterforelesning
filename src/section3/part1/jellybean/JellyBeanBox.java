...
public class JellyBeanBox implements Comparable<JellyBeanBox> {
	...
	public int compareTo(JellyBeanBox other) {
		if(this.beanCount == other.beanCount) {
			return this.flavor.compareTo(other.flavor);
		}
		else {
			return this.beanCount - other.beanCount;
		}
	}
}
